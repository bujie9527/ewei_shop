                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                if( $item["id"] == "shortVideo" ) 
                                                {
                                                    ...
                                                    {
                                                        $item["params"]["turl"] = parseTencentVideo($item["params"]["shortVideourl"]);
                                                    }
                                                    else
                                                    {
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        if( $item["id"] == "member" ) 
                                        {
                                            ...
                                            $item["info"] = array( "id" => $member["id"], "avatar" => $member["avatar"], "nickname" => $member["nickname"], "levelname" => $level["levelname"], "textmoney" => $_W["shopset"]["trade"]["moneytext"], "textcredit" => $_W["shopset"]["trade"]["credittext"], "money" => $member["credit2"], "credit" => intval($member["credit1"]), "membercard" => count($list_membercard["list"]) );
                                        }
                                        else
                                        {
                                            if( $item["id"] == "verify" ) 
                                                    ...
                                                    else
                                                    {
                                                        ...
                                                        else
                                                        {
                                                            if( $item["id"] == "memberc" ) 
                                                            {
                                                                ...
                                                                if( empty($member["commissionlevel"]) ) 
                                                                {
                                                                    $member["commissionlevel"]["levelname"] = $commission["set"]["levelname"];
                                                                }
                                                                ...
                                                                $item["params"]["levelname"] = ($member["commissionlevel"]["levelname"] ?: "默认等级");
                                                                ...
                                                                $item["params"]["upmember"] = (empty($up) ? "总店" : $up["nickname"]);
